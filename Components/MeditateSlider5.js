...
// import "../Css/Home.css";
import {cardData13} from './cardData';
import DynamicTitle2 from './DynamicTitle2';
function MeditateSlider5({playAudio}) {
...
<div className='components-card'>
 ...
 <div className='Box-title'> <p>Practice Tips with Tamara</p></div>
  ...
  pagination={false}
    ref={CarouselRef}
      >
         ...
         {cardData13.map((card, index) => (

          <div className={`rec-carousel-item small-carousel-item`} key={index} onClick={() => handleButtonClick(card.audioSrc ,card.imageSrc,card.title,card.description)}>
          <div className='Card'>
...
export default MeditateSlider5