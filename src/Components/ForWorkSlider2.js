...
// import "../Css/Home.css";
import {cardData24} from './cardData';
import DynamicTitle2 from './DynamicTitle2';
function ForWorkSlider2() {
...
<div className='components-card'>
 ...
 <div className='Box-title'> <p>Rise & Shine</p></div>
