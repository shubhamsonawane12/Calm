...
// import "../Css/Home.css";
import {cardData10} from './cardData';
import DynamicTitle2 from './DynamicTitle2';
function MeditateSlider2({playAudio}) {
...
<div className='components-card'>
 ...
 <div className='Box-title'> <p>Sleep Better</p></div>
...
export default MeditateSlider2