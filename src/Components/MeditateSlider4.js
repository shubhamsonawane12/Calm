...
// import "../Css/Home.css";
import {cardData12} from './cardData';
import DynamicTitle2 from './DynamicTitle2';
function MeditateSlider4({playAudio}) {
...
<div className='components-card'>
 ...
 <div className='Box-title'> <p>For Beginners</p></div>
...
export default MeditateSlider4