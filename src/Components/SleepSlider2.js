...
// import "../Css/Home.css";
import {cardData17} from './cardData';
import DynamicTitle2 from './DynamicTitle2';
function SleepSlider2({playAudio}) {
...
<div className='components-card'>
 ...
 <div className='Box-title'> <p>Celebrated Voices</p></div>
