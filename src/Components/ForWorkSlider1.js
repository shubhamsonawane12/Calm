...
// import "../Css/Home.css";
import {cardData28} from './cardData';
import DynamicTitle2 from './DynamicTitle2';
function ForWorkSlider1() {
...
<div className='components-card'>
 ...
 <div className='Box-title'> <p>Quick Breaks</p></div>
